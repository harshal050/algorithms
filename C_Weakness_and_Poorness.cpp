                            ...
                            double getMinSubarraySum(vector<double>v, int n)
                            {
                                double sm=0 , mn = v[0];
                                f(i,n){
                                    sm+=v[i];
                            ...
                            double getMaxSubarraySum(vector<double>v, int n)
                            {
                                double sm=0 , mx = v[0];
                                f(i,n){
                                    sm+=v[i];
                            ...
                            double pi_max(double x , vector<pair<double , double>> vp){
                                double mx=-1e9;
                                f(i,vp.size()){
                                    int pi = vp[i].first * x + vp[i].second;
                                    if(pi>mx) mx = pi; 
                                }
                                return mx;
                            }

                            double pi_min(double x , vector<pair<double , double>> vp){
                                double mn=1e9;
                                f(i,vp.size()){
                                    int pi = vp[i].first * x + vp[i].second;
                                    if(pi<mn) mn = pi; 
                            ...
                            double fun(double X , vector<pair<double , double>> vp)
                            {
                                return pi_max(X ,vp) - pi_min(X , vp);
                                
                            }

                       

                        void ts(vector<pair<double , double>> vp,  double k){
                            int n = vp.size();
                            ...
                            while(r-l>0.0000001){
                                double m1 = l + (r-l)/3;
                                double m2 = r - (r-l)/3;
                                double fm1 = fun(m1 , vp);
                                double fm2 = fun(m2 , vp);
                                if(fm1<fm2){
                                    r = m2; 
                                }else if(fm1>fm2){
                                    l = m1;
                            ...
                            double ans = static_cast<double>(fun(l , vp));
                            c(fixed << setprecision(6) << ans)
                        ...
                        void solve(){
                            ...
                            vector<pair<double , double>> vp(a);
                            f(i,a){
