                                    ...
                                    int build(int node , int s,int e, vi &v){
                                        if(s==e){
                                            lazy[node]  = v[s];
                                        }else{
                                            int m = (s+e)/2;
                                    ...
                                    void update(int node , int s, int e , int val , int l ,int h){
                                        if(s>h || e<l) return; 
                                        if(s==e){
                                            lazy[node]+=val;
                                            return;
                                            ...
                                            // propagate(node);
                                            int m = (s+e)/2;
                                            update(node*2+1 , s ,m,val,l,h);
                                            update(node*2+2 , m+1 ,e,val,l,h);//
                                        }
                                    }
                                    ...
                                    int query(int node , int s, int e , int l ,int h){
                                        ...
                                        // }
                                            ...
                                            propagate(node);
                                            int m = (s+e)/2;
                                            int a = query(node*2+1 , s ,m,l,h);
                                            int b = query(node*2+2 , m+1    ,e,l,h);
                                            return a+b;
                                        }
                                    }
