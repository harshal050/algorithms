                ...
                void solve()
                {
                    ...
                    vector<char>sts,temp(26 , 'a');
                    
                    vector<pair<char ,char>>vp(st.size()) , vp2(26);
                    ...
                    f(i,sts.size()){    
                        // cout<<sts[i]<<" "<<sts[nn-i-1]<<endl;
                        vp.pb({sts[i]  , sts[nn-i-1]});
                    }
                    f(i,vp.size()){
                        // cout<<i<<" "<<vp[i].first<<" "<<vp[i].second<<endl;
                        temp[(int)vp[i].first-(97)] = vp[i].second;
                    }
                    ...
                    // int ind =0;
                    // f(i,26){
                    //     if(vp[ind].first == char(97+i)){
                    //         temp[i] = vp[ind].second;
                    //         ind++;
                    //     }
                    //     cout<<temp[i];
                    // }
                    // f(i,26) cout<<temp[i]<<" "<<temp[i];
