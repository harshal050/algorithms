                        ...
                        double fun(double x , vector<pair<double,double>>vp , double v1 , double v2){

                            double a1 = abs(x - vp[0].first);
                            double b1 = abs(vp[0].second);
                            double a2 = abs(x - vp[1].first);
                            double b2 = abs(vp[1].second);
                            
                            double left_side = (sqrt(a1*a1) + sqrt(b1*b1));
                            double right_side = (sqrt(a2*a2) + sqrt(b2*b2));

                            double t1 = (left_side/v1);
                            double t2 =  (right_side/v2);
                        ...
                        void ts(vector<pair<double,double>> vp , double v1 , double v2){
                            int n = vp.size();
                            double l = min(vp[0].first  , vp[1].first);
                            double r = max(vp[0].first  , vp[1].first);
                            // c(l<<" "<<r)

                            while(r-l>0.00001){
                                double m1 = l + (r-l)/3;
                                double m2 = r - (r-l)/3;
                                double fm1 = fun(m1 , vp,v1,v2);
                                double fm2 = fun(m2 , vp,v1,v2);
                                if(fm1<fm2){
                                    r = m2;
                                }else if(fm1>fm2){
                                    l = m1;
