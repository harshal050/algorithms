    ...
    void solve(){
            makeab
            vector<vector<char>> ch(a, vector<char>(b, a));
            vi bb(4,0),aa(4,0);
            ...
            if(a==1 && b==1) c("YES")
                ...
                if(ch[0][0]==ch[0][b-1]) c("YES")
                else c("NO")
            }
            else if(b==1 && a>1){
                if(ch[0][0]==ch[a-1][0]) c("YES")
                else c("NO")
            }
            else{

            bool b1=0,b2=0,b3=0,b4=0,c1=0,c2=0,c3=0,c4=0;        

            f(i,b){
                if(ch[0][i]=='B' && b1==0) bb[0]=1,b1=1;
                else if(ch[0][i]=='W' && b2==0) aa[0]=1 ,b2=1;


                if(ch[a-1][i]=='B' && b3==0) bb[2]=1 , b3=1;
                else if(ch[a-1][i]=='W' && b4==0) aa[2]=1 ,b4=1;


                if(bb[0]==1 && aa[0]==1 && bb[2]==1 && aa[2]==1) break;
            }
            f(i,a){
                if(ch[i][b-1]=='B' && c1==0) bb[1]=1,c1=1;
                else if(ch[i][b-1]=='W' && c2==0) aa[1]=1,c2=1;

                if(ch[i][0]=='B' && c3==0) bb[3]=1 , c3=1;
                else if(ch[i][0]=='W' && c4==0) aa[3]=1 ,c4=1;

                if((aa[0]==1 && aa[1]==1 && aa[2]==1 && aa[3]==1) || (bb[0]==1 && bb[1]==1 && bb[2]==1 && bb[3]==1)) break;
            }
